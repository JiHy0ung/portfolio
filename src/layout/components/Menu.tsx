    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed top-20 inset-x-0 bottom-24 z-50
        ...
        >
          {menuItems.map((item, i) => (
            ...
            >
              ...
              >
                <span className="font-sans mt-1">[0{i + 1}]</span>
                <span className="relative inline-grid h-24 [perspective:1000px]">
                  ...
                  <div className="h-24 col-start-1 row-start-1 grid grid-cols-1 grid-rows-1 [transform-style:preserve-3d] transition-transform duration-500 ease-out group-hover:[transform:rotateX(180deg)]">
                    <span
